...
gyro.reset_angle(0)
if In<=12:
    Distance2 = ((In+4)/11)*300
elif In<=24:
    Distance2 = ((In+5+In/12 )/11)*300
elif In<=36:
    Distance2 = ((In+6+In/12 )/11)*300
elif In<=48:
    Distance2 = ((In+7+In/12 )/11)*300
elif In<=60:
    Distance2=((In+8+In/12)/11)*300
elif In<=84:
    Distance2=((In+9+In/12)/11)*300
if Distance2 >0:

    while robot.distance() <= Distance2:
        correction = (0 - gyro.angle())*GSPK
        robot.drive(speed, correction)
    robot.stop()
    left_motor.brake()
